...
/**
 * REST controller for managing {@link com.esi.gnote.domain.AnneeScolaire}.
 */
@RestController
@RequestMapping("/api")
public class AnneeScolaireResource {
    ...
    public ResponseEntity<AnneeScolaireDTO> createAnneeScolaire(@Valid @RequestBody AnneeScolaireDTO anneeScolaireDTO)
    ...
    public ResponseEntity<AnneeScolaireDTO> updateAnneeScolaire(
        ...
        AnneeScolaireDTO result = anneeScolaireService.update(anneeScolaireDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<AnneeScolaireDTO>> getAllAnneeScolaires(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
