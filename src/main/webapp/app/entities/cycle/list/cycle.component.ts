...
export class CycleComponent implements OnInit {
  ...
  trackId(_index: number, item: ICycle): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICycle[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
