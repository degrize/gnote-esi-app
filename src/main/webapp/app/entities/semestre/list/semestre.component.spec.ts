...
describe('Semestre Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'semestre', component: SemestreComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.semestres?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
