...
export class SemestreComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.semestreService
      ...
      .subscribe({
        next: (res: HttpResponse<ISemestre[]>) => {
  ...
  trackId(_index: number, item: ISemestre): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ISemestre[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
