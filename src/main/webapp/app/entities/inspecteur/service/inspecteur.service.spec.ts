...
describe('Inspecteur Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      nomInspecteur: 'AAAAAAA',
      prenomInspecteur: 'AAAAAAA',
      contactInspecteur: 'AAAAAAA',
    };
  });
  ...
  describe('Service methods', () => {
    ...
    it('should update a Inspecteur', () => {
      const returnedFromService = Object.assign(
        {
          id: 1,
          nomInspecteur: 'BBBBBB',
          prenomInspecteur: 'BBBBBB',
          contactInspecteur: 'BBBBBB',
        },
        elemDefault
      );
    ...
    describe('addInspecteurToCollectionIfMissing', () => {
      ...
      it('should add only unique Inspecteur to an array', () => {
        const inspecteurArray: IInspecteur[] = [{ id: 123 }, { id: 456 }, { id: 30639 }];
