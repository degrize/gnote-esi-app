...
describe('Horaire Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'horaire', component: HoraireComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.horaires?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
