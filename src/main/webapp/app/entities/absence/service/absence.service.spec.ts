...
describe('Absence Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      heureDebut: 'AAAAAAA',
      heureFin: 'AAAAAAA',
      justificationEcrit: 'AAAAAAA',
      justificationNumeriqueContentType: 'image/png',
      justificationNumerique: 'AAAAAAA',
    };
  });
      ...
      const returnedFromService = Object.assign(
        {
          ...
          heureDebut: 'BBBBBB',
          heureFin: 'BBBBBB',
          justificationEcrit: 'BBBBBB',
          justificationNumerique: 'BBBBBB',
        },
        elemDefault
      );
