...
describe('Planche Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'planche', component: PlancheComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.planches?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
