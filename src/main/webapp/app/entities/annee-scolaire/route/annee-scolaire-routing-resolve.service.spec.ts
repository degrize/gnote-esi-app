...
describe('AnneeScolaire routing resolve service', () => {
  ...
  let resultAnneeScolaire: IAnneeScolaire | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IAnneeScolaire if id is not provided', () => {
      // GIVEN
      ...
      expect(resultAnneeScolaire).toEqual(new AnneeScolaire());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as AnneeScolaire })));
      mockActivatedRouteSnapshot.params = { id: 123 };
